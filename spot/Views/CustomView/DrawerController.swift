...
class DrawerController: UIViewController ,UIGestureRecognizerDelegate {
    ...
    func removeFromParentView(tagNum:Int){
        if let viewControllers = self.childViewControllers as? [UIViewController]{
            for viewController in viewControllers {
                if tagNum == viewController.view.tag{
    ...
    var rootViewController:UIViewController?{
        willSet{
            if (newValue != nil) {
                newValue?.view.tag = 6009
                self.removeFromParentView(6009)
            }
        }
        didSet{
    ...
    var leftViewController:UIViewController?{
        willSet{
            if (newValue) != nil {
                newValue?.view.tag = 6008
                self.removeFromParentView(6008)
            }
    ...
    var rightViewController:UIViewController?{
        willSet{
            if (newValue != nil) {
                newValue?.view.tag = 6007
                self.removeFromParentView(6007)
            }
        }
        didSet{
